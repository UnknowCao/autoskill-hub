...
>
> **加载时机**：Phase 2 现有技术检索（`shared_workflow.md` § Step 2.1-2.7）。**撰写语言规范在另一文件** [`language_conventions.md`](./language_conventions.md)（Phase 3A Action 2 / Phase 3D Action 8 加载）。
